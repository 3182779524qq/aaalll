<template>
    <div class="agile"
         ...
         <div class="agile-count">{{currentSlide+1}}/{{slidesCount}}</div>
        ...
        <ul ref="dots" v-if="settings.dots && !settings.unagile" class="agile__dots">
            <li v-for="n in slidesCount" class="agile__dot" :key="n"
    ...
    export default {
        ...
        methods: {
            ...
            handleMouseOut (element) {
                // console.log(this.slidesCount,this.currentSlide)
                if (this.settings.autoplay) {
                    if ((element === 'dot' && this.settings.pauseOnDotsHover) || (element === 'track' && this.settings.pauseOnHover)) {
            ...
            setSlide (n, transition = true, autoplayTimeout = true) {
                ...
                // console.log(this.currentSlide,this.slidesCount)
            },
